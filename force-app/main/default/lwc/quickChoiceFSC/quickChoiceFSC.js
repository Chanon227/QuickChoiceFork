...
import Quickchoice_Images from '@salesforce/resourceUrl/Quickchoice_Images';    // Must have a Static Resource Zip file called 'Quickchoice_Images' where the image files are stored
...
export default class SmartChoiceFSC extends LightningElement {
	...
	@api choiceTitles; //string collection CUSTOM
		...
		if (this.legitInputModes.includes(this.inputMode)) {
			switch (this.inputMode) {
				...
				case "Visual Text Box":
					...
					console.log("choiceTitles is: " + this.choiceTitles); // CUSTOM
					this.choiceLabels.forEach(label => {
						//Adding functionality for avatar instead of icons
